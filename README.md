...
- Add a GitHub Actions workflow to build and deploy to GitHub Pages automatically.
- Add an offline fallback HTML page and cache it.
- Add tests or a small CI step to validate `manifest.json` and `sw.js` before publishing.
